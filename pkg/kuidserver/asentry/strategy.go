...
func NewStrategy(ctx context.Context, typer runtime.ObjectTyper, client client.Client, store storebackend.Storer[runtime.Object], be backend.Backend[*as.CacheContext]) *strategy {
	...
	return &strategy{
		...
		resource:       &asbe1v1alpha1.ASEntry{},
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	api, ok := obj.(*asbe1v1alpha1.ASEntry)
	if !ok {
		return nil, nil, fmt.Errorf("given object is not a %s", asbe1v1alpha1.ASEntryKind)
	}
	return labels.Set(api.ObjectMeta.Labels), SelectableFields(api), nil
}

// SelectableFields returns a field set that represents the object.
func SelectableFields(obj *asbe1v1alpha1.ASEntry) fields.Set {
