...
func (r *strategy) Update(ctx context.Context, key types.NamespacedName, obj, old runtime.Object, dryrun bool) (runtime.Object, error) {
	...
	newObj, ok := obj.(*asbe1v1alpha1.ASEntry)
	if !ok {
		return obj, fmt.Errorf("unexpected new object, expecting: %s, got: %s", asbe1v1alpha1.ASEntryKind, reflect.TypeOf(obj))
	}
	oldObj, ok := old.(*asbe1v1alpha1.ASEntry)
	if !ok {
		return obj, fmt.Errorf("unexpected old object, expecting: %s, got: %s", asbe1v1alpha1.ASEntryKind, reflect.TypeOf(obj))
	}
