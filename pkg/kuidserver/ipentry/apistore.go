...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config, be backend.Backend) (rest.Storage, error) {
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &ipambe1v1alpha1.IPEntry{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &ipambe1v1alpha1.IPEntry{})
		if err != nil {
			return nil, err
		}
	default:
	...
	gr := ipambe1v1alpha1.Resource(ipambe1v1alpha1.IPEntryPlural)
	strategy := NewStrategy(ctx, scheme, client, configStore, be)

	// This is the etcd store
	store := &registry.Store{
		Tracer:                    otel.Tracer("ipentry-server"),
		NewFunc:                   func() runtime.Object { return &ipambe1v1alpha1.IPEntry{} },
		NewListFunc:               func() runtime.Object { return &ipambe1v1alpha1.IPEntryList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: ipambe1v1alpha1.Resource(ipambe1v1alpha1.IPEntrySingular),
		...
		TableConvertor: NewTableConvertor(ipambe1v1alpha1.Resource(ipambe1v1alpha1.IPEntryPlural)),
	}
