...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config, be backend.Backend) (rest.Storage, error) {
	scheme.AddFieldLabelConversionFunc(
		schema.GroupVersionKind{
			...
			Kind:    vlanbe1v1alpha1.VLANIndexKind,
		},
		vlanbe1v1alpha1.ConvertVLANIndexFieldSelector,
	)
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &vlanbe1v1alpha1.VLANIndex{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &vlanbe1v1alpha1.VLANIndex{})
		if err != nil {
			return nil, err
		}
	default:
	...
	gr := vlanbe1v1alpha1.Resource(vlanbe1v1alpha1.VLANIndexPlural)
	strategy := NewStrategy(ctx, scheme, client, configStore, be)

	// This is the etcd store
	store := &registry.Store{
		Tracer:                    otel.Tracer("vlanindex-server"),
		NewFunc:                   func() runtime.Object { return &vlanbe1v1alpha1.VLANIndex{} },
		NewListFunc:               func() runtime.Object { return &vlanbe1v1alpha1.VLANIndexList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: vlanbe1v1alpha1.Resource(vlanbe1v1alpha1.VLANIndexSingular),
		...
		TableConvertor: NewTableConvertor(vlanbe1v1alpha1.Resource(vlanbe1v1alpha1.VLANIndexPlural)),
	}
