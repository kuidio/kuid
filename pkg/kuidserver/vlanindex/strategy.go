...
func NewStrategy(ctx context.Context, typer runtime.ObjectTyper, client client.Client, store storebackend.Storer[runtime.Object], be backend.Backend[*vlan.CacheContext]) *strategy {
	...
	return &strategy{
		...
		resource:       &vlanbe1v1alpha1.VLANIndex{},
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	api, ok := obj.(*vlanbe1v1alpha1.VLANIndex)
	if !ok {
		return nil, nil, fmt.Errorf("given object is not a %s", vlanbe1v1alpha1.VLANIndexKind)
	}
	return labels.Set(api.ObjectMeta.Labels), SelectableFields(api), nil
}

// SelectableFields returns a field set that represents the object.
func SelectableFields(obj *vlanbe1v1alpha1.VLANIndex) fields.Set {
