...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config, be backend.Backend[*vxlan.CacheContext]) (rest.Storage, error) {
	scheme.AddFieldLabelConversionFunc(
		schema.GroupVersionKind{
			...
			Kind:    vxlanbe1v1alpha1.VXLANIndexKind,
		},
		vxlanbe1v1alpha1.ConvertVXLANIndexFieldSelector,
	)
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &vxlanbe1v1alpha1.VXLANIndex{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &vxlanbe1v1alpha1.VXLANIndex{})
		if err != nil {
			return nil, err
		}
	default:
	...
	gr := vxlanbe1v1alpha1.Resource(vxlanbe1v1alpha1.VXLANIndexPlural)
	strategy := NewStrategy(ctx, scheme, client, configStore, be)

	// This is the etcd store
	store := &registry.Store{
		Tracer:                    otel.Tracer("vxlanindex-server"),
		NewFunc:                   func() runtime.Object { return &vxlanbe1v1alpha1.VXLANIndex{} },
		NewListFunc:               func() runtime.Object { return &vxlanbe1v1alpha1.VXLANIndexList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: vxlanbe1v1alpha1.Resource(vxlanbe1v1alpha1.VXLANIndexSingular),
		...
		TableConvertor: NewTableConvertor(vxlanbe1v1alpha1.Resource(vxlanbe1v1alpha1.VXLANIndexPlural)),
	}
