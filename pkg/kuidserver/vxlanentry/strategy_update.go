...
func (r *strategy) Update(ctx context.Context, key types.NamespacedName, obj, old runtime.Object, dryrun bool) (runtime.Object, error) {
	...
	newObj, ok := obj.(*vxlanbe1v1alpha1.VXLANEntry)
	if !ok {
		return obj, fmt.Errorf("unexpected new object, expecting: %s, got: %s", vxlanbe1v1alpha1.VXLANEntryKind, reflect.TypeOf(obj))
	}
	oldObj, ok := old.(*vxlanbe1v1alpha1.VXLANEntry)
	if !ok {
		return obj, fmt.Errorf("unexpected old object, expecting: %s, got: %s", vxlanbe1v1alpha1.VXLANEntryKind, reflect.TypeOf(obj))
	}
