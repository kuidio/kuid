...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config, be backend.Backend) (rest.Storage, error) {
	scheme.AddFieldLabelConversionFunc(
		schema.GroupVersionKind{
			...
			Kind:    vxlanbe1v1alpha1.VXLANEntryKind,
		},
		vxlanbe1v1alpha1.ConvertVXLANEntryFieldSelector,
	)
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &vxlanbe1v1alpha1.VXLANEntry{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &vxlanbe1v1alpha1.VXLANEntry{})
		if err != nil {
			return nil, err
		}
	default:
	...
	store := &registry.Store{
		Tracer:                    otel.Tracer("vxlanentry-server"),
		NewFunc:                   func() runtime.Object { return &vxlanbe1v1alpha1.VXLANEntry{} },
		NewListFunc:               func() runtime.Object { return &vxlanbe1v1alpha1.VXLANEntryList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: vxlanbe1v1alpha1.Resource(vxlanbe1v1alpha1.VXLANEntrySingular),
		...
		TableConvertor: NewTableConvertor(vxlanbe1v1alpha1.Resource(vxlanbe1v1alpha1.VXLANEntryPlural)),
	}
