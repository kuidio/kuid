...
func NewREST(ctx context.Context, scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, client client.Client, storeConfig *store.Config, be backend.Backend) (rest.Storage, error) {
	scheme.AddFieldLabelConversionFunc(
		schema.GroupVersionKind{
			...
			Kind:    asbe1v1alpha1.ASIndexKind,
		},
		asbe1v1alpha1.ConvertASIndexFieldSelector,
	)
	...
	case store.StorageType_File:
		configStore, err = store.CreateFileStore(ctx, scheme, &asbe1v1alpha1.ASIndex{}, storeConfig.Prefix)
		if err != nil {
			return nil, err
		}
	case store.StorageType_KV:
		configStore, err = store.CreateKVStore(ctx, storeConfig.DB, scheme, &asbe1v1alpha1.ASIndex{})
		if err != nil {
			return nil, err
		}
	default:
	...
	gr := asbe1v1alpha1.Resource(asbe1v1alpha1.ASIndexPlural)
	strategy := NewStrategy(ctx, scheme, client, configStore, be)

	// This is the etcd store
	store := &registry.Store{
		Tracer:                    otel.Tracer("vlanindex-server"),
		NewFunc:                   func() runtime.Object { return &asbe1v1alpha1.ASIndex{} },
		NewListFunc:               func() runtime.Object { return &asbe1v1alpha1.ASIndexList{} },
		PredicateFunc:             Match,
		DefaultQualifiedResource:  gr,
		SingularQualifiedResource: asbe1v1alpha1.Resource(asbe1v1alpha1.ASIndexSingular),
		...
		TableConvertor: NewTableConvertor(asbe1v1alpha1.Resource(asbe1v1alpha1.ASIndexPlural)),
	}
