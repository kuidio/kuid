...
func NewStrategy(ctx context.Context, typer runtime.ObjectTyper, client client.Client, store storebackend.Storer[runtime.Object], be backend.Backend) *strategy {
	...
	return &strategy{
		...
		resource:       &vxlanbe1v1alpha1.VXLANClaim{},
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	api, ok := obj.(*vxlanbe1v1alpha1.VXLANClaim)
	if !ok {
		return nil, nil, fmt.Errorf("given object is not a %s", vxlanbe1v1alpha1.VXLANClaimKind)
	}
	return labels.Set(api.ObjectMeta.Labels), SelectableFields(api), nil
}

// SelectableFields returns a field set that represents the object.
func SelectableFields(obj *vxlanbe1v1alpha1.VXLANClaim) fields.Set {
