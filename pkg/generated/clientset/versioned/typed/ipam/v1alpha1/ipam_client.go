...
// IpamV1alpha1Client is used to interact with features provided by the ipam.be.kuid.dev group.
...
func (c *IpamV1alpha1Client) IPEntries(namespace string) IPEntryInterface {
	return newIPEntries(c, namespace)
}

func (c *IpamV1alpha1Client) IPIndexes(namespace string) IPIndexInterface {
	return newIPIndexes(c, namespace)
}
