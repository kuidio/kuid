...
func (c *FakeASEntries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ASEntry, err error) {
	emptyResult := &v1alpha1.ASEntry{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(asentriesResource, c.ns, name, options), emptyResult)
...
func (c *FakeASEntries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ASEntryList, err error) {
	emptyResult := &v1alpha1.ASEntryList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(asentriesResource, asentriesKind, c.ns, opts), emptyResult)
...
func (c *FakeASEntries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(asentriesResource, c.ns, opts))
...
func (c *FakeASEntries) Create(ctx context.Context, aSEntry *v1alpha1.ASEntry, opts v1.CreateOptions) (result *v1alpha1.ASEntry, err error) {
	emptyResult := &v1alpha1.ASEntry{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(asentriesResource, c.ns, aSEntry, opts), emptyResult)
...
func (c *FakeASEntries) Update(ctx context.Context, aSEntry *v1alpha1.ASEntry, opts v1.UpdateOptions) (result *v1alpha1.ASEntry, err error) {
	emptyResult := &v1alpha1.ASEntry{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(asentriesResource, c.ns, aSEntry, opts), emptyResult)
...
func (c *FakeASEntries) UpdateStatus(ctx context.Context, aSEntry *v1alpha1.ASEntry, opts v1.UpdateOptions) (result *v1alpha1.ASEntry, err error) {
	emptyResult := &v1alpha1.ASEntry{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(asentriesResource, "status", c.ns, aSEntry, opts), emptyResult)
...
func (c *FakeASEntries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(asentriesResource, c.ns, opts, listOpts)
...
func (c *FakeASEntries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ASEntry, err error) {
	emptyResult := &v1alpha1.ASEntry{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(asentriesResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
