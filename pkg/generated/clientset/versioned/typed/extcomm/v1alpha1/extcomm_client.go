...
func (c *ExtcommV1alpha1Client) EXTCOMMClaims(namespace string) EXTCOMMClaimInterface {
	return newEXTCOMMClaims(c, namespace)
}

func (c *ExtcommV1alpha1Client) EXTCOMMEntries(namespace string) EXTCOMMEntryInterface {
	return newEXTCOMMEntries(c, namespace)
}

func (c *ExtcommV1alpha1Client) EXTCOMMIndexes(namespace string) EXTCOMMIndexInterface {
	return newEXTCOMMIndexes(c, namespace)
}

// NewForConfig creates a new ExtcommV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new ExtcommV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ExtcommV1alpha1Client, error) {
	...
	return &ExtcommV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ExtcommV1alpha1Client for the given config and
...
func New(c rest.Interface) *ExtcommV1alpha1Client {
	return &ExtcommV1alpha1Client{c}
}
