...
func (c *FakeNodes) UpdateStatus(ctx context.Context, node *v1alpha1.Node, opts v1.UpdateOptions) (result *v1alpha1.Node, err error) {
	emptyResult := &v1alpha1.Node{}
	obj, err := c.Fake.
