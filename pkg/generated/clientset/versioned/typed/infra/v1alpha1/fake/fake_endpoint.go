...
func (c *FakeEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointList, err error) {
	emptyResult := &v1alpha1.EndpointList{}
	obj, err := c.Fake.
...
func (c *FakeEndpoints) UpdateStatus(ctx context.Context, endpoint *v1alpha1.Endpoint, opts v1.UpdateOptions) (result *v1alpha1.Endpoint, err error) {
	emptyResult := &v1alpha1.Endpoint{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(endpointsResource, "status", c.ns, endpoint, opts), emptyResult)
