...
func (c *FakeRegions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Region, err error) {
	emptyResult := &v1alpha1.Region{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(regionsResource, c.ns, name, options), emptyResult)
...
func (c *FakeRegions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionList, err error) {
	emptyResult := &v1alpha1.RegionList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(regionsResource, regionsKind, c.ns, opts), emptyResult)
...
func (c *FakeRegions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(regionsResource, c.ns, opts))
...
func (c *FakeRegions) Create(ctx context.Context, region *v1alpha1.Region, opts v1.CreateOptions) (result *v1alpha1.Region, err error) {
	emptyResult := &v1alpha1.Region{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(regionsResource, c.ns, region, opts), emptyResult)
...
func (c *FakeRegions) Update(ctx context.Context, region *v1alpha1.Region, opts v1.UpdateOptions) (result *v1alpha1.Region, err error) {
	emptyResult := &v1alpha1.Region{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(regionsResource, c.ns, region, opts), emptyResult)
...
func (c *FakeRegions) UpdateStatus(ctx context.Context, region *v1alpha1.Region, opts v1.UpdateOptions) (result *v1alpha1.Region, err error) {
	emptyResult := &v1alpha1.Region{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(regionsResource, "status", c.ns, region, opts), emptyResult)
...
func (c *FakeRegions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(regionsResource, c.ns, opts, listOpts)
...
func (c *FakeRegions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Region, err error) {
	emptyResult := &v1alpha1.Region{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(regionsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
