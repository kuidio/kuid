...
type ports struct {
	*gentype.ClientWithList[*v1alpha1.Port, *v1alpha1.PortList]
}

// newPorts returns a Ports
func newPorts(c *InfraV1alpha1Client, namespace string) *ports {
	return &ports{
		gentype.NewClientWithList[*v1alpha1.Port, *v1alpha1.PortList](
			"ports",
			c.RESTClient(),
