...
func (r *be) CreateIndex(ctx context.Context, obj runtime.Object) error {
	cr, ok := obj.(*vlanbev1alpha1.VLANIndex)
	if !ok {
		return fmt.Errorf("cannot create index expecting %s, got %s", vlanbev1alpha1.VLANIndexKind, reflect.TypeOf(obj).Name())
	}
...
func (r *be) DeleteIndex(ctx context.Context, obj runtime.Object) error {
	cr, ok := obj.(*vlanbev1alpha1.VLANIndex)
	if !ok {
		return fmt.Errorf("cannot delete index expecting %s, got %s", vlanbev1alpha1.VLANIndexKind, reflect.TypeOf(obj).Name())
	}
...
func (r *be) Claim(ctx context.Context, obj runtime.Object) error {
	claim, ok := obj.(*vlanbev1alpha1.VLANClaim)
	if !ok {
		return fmt.Errorf("cannot claim expecting %s, got %s", vlanbev1alpha1.VLANClaimKind, reflect.TypeOf(obj).Name())
	}
...
func (r *be) Release(ctx context.Context, obj runtime.Object) error {
	claim, ok := obj.(*vlanbev1alpha1.VLANClaim)
	if !ok {
		return fmt.Errorf("cannot delete claim expecting %s, got %s", vlanbev1alpha1.VLANIndexKind, reflect.TypeOf(obj).Name())
	}
...
func getApplicator(_ context.Context, cacheCtx *CacheContext, claim *vlanbev1alpha1.VLANClaim) (Applicator, error) {
	...
	case vlanbev1alpha1.VLANClaimType_DynamicID:
		a = &dynamicVLANApplicator{name: string(claimType), applicator: applicator{cacheCtx: cacheCtx}}
