...
type dynamicASApplicator struct {
	name string
	applicator
	claimID        *uint32
...
func (r *dynamicASApplicator) Validate(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
func (r *dynamicASApplicator) reclaimID(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
func (r *dynamicASApplicator) getParentContext(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
func (r *dynamicASApplicator) Apply(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
	log := log.FromContext(ctx).With("name", claim.GetName())
...
func (r *dynamicASApplicator) Delete(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
