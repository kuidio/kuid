...
type Applicator interface {
	Validate(ctx context.Context, claim *asbev1alpha1.ASClaim) error
	Apply(ctx context.Context, claim *asbev1alpha1.ASClaim) error
	Delete(ctx context.Context, claim *asbev1alpha1.ASClaim) error
}
...
func (r *applicator) getEntriesByOwner(ctx context.Context, claim *asbev1alpha1.ASClaim) (map[string]tree.Entries, error) {
	...
	if len(treeEntries) != 0 {
		...
		if len(treeEntries[""]) > 1 && (claimType != asbev1alpha1.ASClaimType_Range) {
...
func (r *applicator) delete(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
func (r *applicator) getEntriesByLabelSelector(ctx context.Context, claim *asbev1alpha1.ASClaim) tree.Entries {
...
func isReserved(parentName, index string) bool {
	return parentName == fmt.Sprintf("%s.%s", index, asbev1alpha1.ASIndexReservedMaxName) ||
		parentName == fmt.Sprintf("%s.%s", index, asbev1alpha1.ASIndexReservedMinName)
}
