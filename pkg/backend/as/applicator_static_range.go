...
func (r *rangeASApplicator) Validate(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
// -> same exist -> delete them including the children and reclaim the new range aftre the entries
// have been deleted
func (r *rangeASApplicator) reclaimRange(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
...
func (r *rangeASApplicator) validateRangeOverlap(_ context.Context, claim *asbev1alpha1.ASClaim) error {
	if claim.Spec.Range == nil {
		return fmt.Errorf("cannot claim a range w/o a range")
	}
	range32, err := id32.ParseRange(*claim.Spec.Range)
...
func (r *rangeASApplicator) Apply(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
	if claim.Spec.Range == nil {
		return fmt.Errorf("cannot claim a range w/o a range")
	}
	range32, err := id32.ParseRange(*claim.Spec.Range)
...
func (r *rangeASApplicator) Delete(ctx context.Context, claim *asbev1alpha1.ASClaim) error {
