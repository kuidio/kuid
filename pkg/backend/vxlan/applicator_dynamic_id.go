...
type dynamicVXLANApplicator struct {
	name string
	applicator
	claimID        *uint32
...
func (r *dynamicVXLANApplicator) Validate(ctx context.Context, claim *vxlanbev1alpha1.VXLANClaim) error {
...
func (r *dynamicVXLANApplicator) reclaimID(ctx context.Context, claim *vxlanbev1alpha1.VXLANClaim) error {
...
func (r *dynamicVXLANApplicator) getParentContext(ctx context.Context, claim *vxlanbev1alpha1.VXLANClaim) error {
...
func (r *dynamicVXLANApplicator) Delete(ctx context.Context, claim *vxlanbev1alpha1.VXLANClaim) error {
