...
type EXTCOMMEntryEventHandler struct {
...
func (r *EXTCOMMEntryEventHandler) add(ctx context.Context, obj runtime.Object, queue adder) {
	cr, ok := obj.(*extcommbev1alpha1.EXTCOMMEntry)
	if !ok {
		return
	}
