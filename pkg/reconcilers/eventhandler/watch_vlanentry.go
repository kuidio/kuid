...
type VLANEntryEventHandler struct {
...
func (r *VLANEntryEventHandler) add(ctx context.Context, obj runtime.Object, queue adder) {
	cr, ok := obj.(*vlanbev1alpha1.VLANEntry)
	if !ok {
		return
	}
