...
type GENIDEntryEventHandler struct {
...
func (r *GENIDEntryEventHandler) add(ctx context.Context, obj runtime.Object, queue adder) {
	cr, ok := obj.(*genidbev1alpha1.GENIDEntry)
	if !ok {
		return
	}
