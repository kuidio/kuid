...
func init() {
	reconcilers.Register("vxlanindex", &reconciler{})
}

const (
	crName         = "vxlanindex"
	controllerName = "VXLANIndexController"
	finalizer      = "vxlanindex.vxlan.res.kuid.dev/finalizer"
	// errors
...
func (r *reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, c interface{}) (map[schema.GroupVersionKind]chan event.GenericEvent, error) {
	...
	r.be = cfg.VXLANBackend

	return nil, ctrl.NewControllerManagedBy(mgr).
		Named(controllerName).
		For(&vxlanbev1alpha1.VXLANIndex{}).
...
func (r *reconciler) handleError(ctx context.Context, cr *vxlanbev1alpha1.VXLANIndex, msg string, err error) {
	log := log.FromContext(ctx)
	if err == nil {
...
func (r *reconciler) deleteIndex(ctx context.Context, cr *vxlanbev1alpha1.VXLANIndex) error {
...
func (r *reconciler) applyIndex(ctx context.Context, cr *vxlanbev1alpha1.VXLANIndex) error {
...
func (r *reconciler) hasMinMaxRangeChanged(cr *vxlanbev1alpha1.VXLANIndex) bool {
...
func (r *reconciler) applyMinMaxRange(ctx context.Context, cr *vxlanbev1alpha1.VXLANIndex) error {
	if cr.Spec.MinID != nil && *cr.Spec.MinID != vxlanbev1alpha1.VXLANID_Min {
	...
	if cr.Spec.MaxID != nil && *cr.Spec.MaxID != vxlanbev1alpha1.VXLANID_Max {
