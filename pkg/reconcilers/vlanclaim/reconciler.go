...
func init() {
	reconcilers.Register("vlanclaim", &reconciler{})
}

const (
	crName         = "vlanClaim"
	controllerName = "VLANClaimController"
...
//+kubebuilder:rbac:groups=vlanclaim.vlan.be.kuid.dev,resources=vlanclaims,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=vlanclaim.vlan.be.kuid.dev,resources=vlanclaims/status,verbs=get;update;patch
...
func (r *reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, c interface{}) (map[schema.GroupVersionKind]chan event.GenericEvent, error) {
	...
	return nil, ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&vlanbev1alpha1.VLANEntry{},
			&eventhandler.VLANEntryEventHandler{
				Client:  mgr.GetClient(),
				ObjList: &vlanbev1alpha1.VLANClaimList{},
			}).
		Complete(r)
}
...
func (r *reconciler) handleError(ctx context.Context, cr *vlanbev1alpha1.VLANClaim, msg string, err error) {
	log := log.FromContext(ctx)
	if err == nil {
