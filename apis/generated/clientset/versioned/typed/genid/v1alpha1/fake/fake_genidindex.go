...
var genidindexesResource = v1alpha1.SchemeGroupVersion.WithResource("genidindexes")

var genidindexesKind = v1alpha1.SchemeGroupVersion.WithKind("GENIDIndex")
...
func (c *FakeGENIDIndexes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GENIDIndex, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(genidindexesResource, c.ns, name), &v1alpha1.GENIDIndex{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GENIDIndex), err
}
...
func (c *FakeGENIDIndexes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GENIDIndexList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(genidindexesResource, genidindexesKind, c.ns, opts), &v1alpha1.GENIDIndexList{})
	...
	list := &v1alpha1.GENIDIndexList{ListMeta: obj.(*v1alpha1.GENIDIndexList).ListMeta}
	for _, item := range obj.(*v1alpha1.GENIDIndexList).Items {
...
func (c *FakeGENIDIndexes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(genidindexesResource, c.ns, opts))
...
func (c *FakeGENIDIndexes) Create(ctx context.Context, gENIDIndex *v1alpha1.GENIDIndex, opts v1.CreateOptions) (result *v1alpha1.GENIDIndex, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(genidindexesResource, c.ns, gENIDIndex), &v1alpha1.GENIDIndex{})
...
func (c *FakeGENIDIndexes) Update(ctx context.Context, gENIDIndex *v1alpha1.GENIDIndex, opts v1.UpdateOptions) (result *v1alpha1.GENIDIndex, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(genidindexesResource, c.ns, gENIDIndex), &v1alpha1.GENIDIndex{})
...
func (c *FakeGENIDIndexes) UpdateStatus(ctx context.Context, gENIDIndex *v1alpha1.GENIDIndex, opts v1.UpdateOptions) (*v1alpha1.GENIDIndex, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(genidindexesResource, "status", c.ns, gENIDIndex), &v1alpha1.GENIDIndex{})
...
func (c *FakeGENIDIndexes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(genidindexesResource, c.ns, name, opts), &v1alpha1.GENIDIndex{})
...
func (c *FakeGENIDIndexes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(genidindexesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.GENIDIndexList{})
	return err
}
...
func (c *FakeGENIDIndexes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GENIDIndex, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(genidindexesResource, c.ns, name, pt, data, subresources...), &v1alpha1.GENIDIndex{})
