...
func (c *regions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Region, err error) {
...
func (c *regions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionList, err error) {
...
func (c *regions) Create(ctx context.Context, region *v1alpha1.Region, opts v1.CreateOptions) (result *v1alpha1.Region, err error) {
	result = &v1alpha1.Region{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regions").
...
func (c *regions) Update(ctx context.Context, region *v1alpha1.Region, opts v1.UpdateOptions) (result *v1alpha1.Region, err error) {
	result = &v1alpha1.Region{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regions").
...
func (c *regions) UpdateStatus(ctx context.Context, region *v1alpha1.Region, opts v1.UpdateOptions) (result *v1alpha1.Region, err error) {
	result = &v1alpha1.Region{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regions").
...
func (c *regions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Region, err error) {
	result = &v1alpha1.Region{}
