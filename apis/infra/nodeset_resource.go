...
var _ resource.InternalObject = &NodeSet{}
var _ resource.ObjectList = &NodeSetList{}
var _ resource.ObjectWithStatusSubResource = &NodeSet{}
var _ resource.StatusSubResource = &NodeSetStatus{}
...
func (NodeSetStatus) SubResourceName() string {
	return fmt.Sprintf("%s/%s", NodeSetPlural, "status")
}
