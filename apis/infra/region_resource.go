...
var _ resource.InternalObject = &Region{}
var _ resource.ObjectList = &RegionList{}
var _ resource.ObjectWithStatusSubResource = &Region{}
var _ resource.StatusSubResource = &RegionStatus{}
...
func (RegionStatus) SubResourceName() string {
	return fmt.Sprintf("%s/%s", RegionPlural, "status")
}
