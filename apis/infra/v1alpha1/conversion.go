...
func autoConvert_v1alpha1_AdaptorID_To_id_AdaptorID(in *idv1alpha1.PartitionAdaptorID, out *id.PartitionAdaptorID, s conversion.Scope) error {
	if err := Convert_v1alpha1_PartitionNodeID_To_id_PartitionNodeID(&in.PartitionNodeID, &out.PartitionNodeID, s); err != nil {
		return err
	}
	out.ModuleBay = (*uint32)(unsafe.Pointer(in.ModuleBay))
	out.Module = (*uint32)(unsafe.Pointer(in.Module))
	out.Port = in.Port
...
func autoConvert_id_AdaptorID_To_v1alpha1_AdaptorID(in *id.PartitionAdaptorID, out *idv1alpha1.PartitionAdaptorID, s conversion.Scope) error {
...
func Convert_v1alpha1_PartitionPortID_To_id_PartitionPortID(in *idv1alpha1.PartitionPortID, out *id.PartitionPortID, s conversion.Scope) error {
	return autoConvert_v1alpha1_PartitionPortID_To_id_PartitionPortID(in, out, s)
}

func autoConvert_v1alpha1_PartitionPortID_To_id_PartitionPortID(in *idv1alpha1.PartitionPortID, out *id.PartitionPortID, s conversion.Scope) error {
	if err := Convert_v1alpha1_PartitionNodeID_To_id_PartitionNodeID(&in.PartitionNodeID, &out.PartitionNodeID, s); err != nil {
		return err
	}
	out.ModuleBay = (*uint32)(unsafe.Pointer(in.ModuleBay))
...
func Convert_id_PartitionPortID_To_v1alpha1_PartitionPortID(in *id.PartitionPortID, out *idv1alpha1.PartitionPortID, s conversion.Scope) error {
	return autoConvert_id_PartitionPortID_To_v1alpha1_PortID(in, out, s)
}

func autoConvert_id_PartitionPortID_To_v1alpha1_PortID(in *id.PartitionPortID, out *idv1alpha1.PartitionPortID, s conversion.Scope) error {
	if err := Convert_id_PartitionNodeID_To_v1alpha1_PartitionNodeID(&in.PartitionNodeID, &out.PartitionNodeID, s); err != nil {
		return err
	}
	out.ModuleBay = (*uint32)(unsafe.Pointer(in.ModuleBay))
...
func Convert_v1alpha1_PartitionAdaptorID_To_id_PartitionAdaptorID(in *idv1alpha1.PartitionAdaptorID, out *id.PartitionAdaptorID, s conversion.Scope) error {
	return autoConvert_v1alpha1_PartitionAdaptorID_To_id_AdaptorPortID(in, out, s)
}

func autoConvert_v1alpha1_PartitionAdaptorID_To_id_AdaptorPortID(in *idv1alpha1.PartitionAdaptorID, out *id.PartitionAdaptorID, s conversion.Scope) error {
...
func Convert_id_PartitionAdaptorID_To_v1alpha1_PartitionAdaptorID(in *id.PartitionAdaptorID, out *idv1alpha1.PartitionAdaptorID, s conversion.Scope) error {
	return autoConvert_id_PartitionAdaptorID_To_v1alpha1_AdaptorID(in, out, s)
}

func autoConvert_id_PartitionAdaptorID_To_v1alpha1_AdaptorID(in *id.PartitionAdaptorID, out *idv1alpha1.PartitionAdaptorID, s conversion.Scope) error {
