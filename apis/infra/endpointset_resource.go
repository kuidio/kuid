...
var _ resource.InternalObject = &EndpointSet{}
var _ resource.ObjectList = &EndpointSetList{}
var _ resource.ObjectWithStatusSubResource = &EndpointSet{}
var _ resource.StatusSubResource = &EndpointSetStatus{}
...
func (r *EndpointSet) IsEqual(ctx context.Context, obj, old runtime.Object) bool {
	newobj := obj.(*EndpointSet)
	oldobj := old.(*EndpointSet)
...
func (EndpointSetStatus) SubResourceName() string {
	return fmt.Sprintf("%s/%s", EndpointSetPlural, "status")
}
...
func (r *EndpointSet) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	newobj := obj.(*EndpointSet)
	newobj.Status = EndpointSetStatus{}
}
