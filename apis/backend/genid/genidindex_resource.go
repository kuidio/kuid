...
var _ resource.InternalObject = &GENIDIndex{}
var _ resource.ObjectList = &GENIDIndexList{}
var _ resource.ObjectWithStatusSubResource = &GENIDIndex{}
var _ resource.StatusSubResource = &GENIDIndexStatus{}
...
func (r *GENIDIndex) IsEqual(ctx context.Context, obj, old runtime.Object) bool {
	newobj := obj.(*GENIDIndex)
	oldobj := old.(*GENIDIndex)
...
func (GENIDIndexStatus) SubResourceName() string {
	return fmt.Sprintf("%s/%s", GENIDIndexPlural, "status")
}

// CopyTo copies the content of the status subresource to a parent resource.
// CopyTo implements the resource.StatusSubResource
func (r GENIDIndexStatus) CopyTo(obj resource.ObjectWithStatusSubResource) {
	parent, ok := obj.(*GENIDIndex)
	if ok {
		parent.Status = r
	}
}
...
func (r *GENIDIndex) FieldSelector() func(ctx context.Context, fieldSelector fields.Selector) (resource.Filter, error) {
	return func(ctx context.Context, fieldSelector fields.Selector) (resource.Filter, error) {
		var filter *GENIDIndexFilter

		// add the namespace to the list
		namespace, ok := genericapirequest.NamespaceFrom(ctx)
		if fieldSelector == nil {
			if ok {
				return &GENIDIndexFilter{Namespace: namespace}, nil
			}
			return filter, nil
		}
		requirements := fieldSelector.Requirements()
		for _, requirement := range requirements {
			filter = &GENIDIndexFilter{}
		...
		if ok {
			if filter != nil {
				...
				filter = &GENIDIndexFilter{Namespace: namespace}
			}
			return filter, nil
		}

		return &GENIDIndexFilter{}, nil
	}
...
func (r *GENIDIndex) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	newobj := obj.(*GENIDIndex)
	newobj.Status = GENIDIndexStatus{}
}
