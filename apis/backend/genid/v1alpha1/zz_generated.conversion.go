...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GENIDIndexClaim)(nil), (*genid.GENIDIndexClaim)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_GENIDIndexClaim_To_genid_GENIDIndexClaim(a.(*GENIDIndexClaim), b.(*genid.GENIDIndexClaim), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*genid.GENIDIndexClaim)(nil), (*GENIDIndexClaim)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_genid_GENIDIndexClaim_To_v1alpha1_GENIDIndexClaim(a.(*genid.GENIDIndexClaim), b.(*GENIDIndexClaim), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_GENIDIndexClaim_To_genid_GENIDIndexClaim(in *GENIDIndexClaim, out *genid.GENIDIndexClaim, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = (*uint64)(unsafe.Pointer(in.ID))
	out.Range = (*string)(unsafe.Pointer(in.Range))
...
func Convert_v1alpha1_GENIDIndexClaim_To_genid_GENIDIndexClaim(in *GENIDIndexClaim, out *genid.GENIDIndexClaim, s conversion.Scope) error {
	return autoConvert_v1alpha1_GENIDIndexClaim_To_genid_GENIDIndexClaim(in, out, s)
}

func autoConvert_genid_GENIDIndexClaim_To_v1alpha1_GENIDIndexClaim(in *genid.GENIDIndexClaim, out *GENIDIndexClaim, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = (*uint64)(unsafe.Pointer(in.ID))
	out.Range = (*string)(unsafe.Pointer(in.Range))
...
func Convert_genid_GENIDIndexClaim_To_v1alpha1_GENIDIndexClaim(in *genid.GENIDIndexClaim, out *GENIDIndexClaim, s conversion.Scope) error {
	return autoConvert_genid_GENIDIndexClaim_To_v1alpha1_GENIDIndexClaim(in, out, s)
}
...
func autoConvert_v1alpha1_GENIDIndexSpec_To_genid_GENIDIndexSpec(in *GENIDIndexSpec, out *genid.GENIDIndexSpec, s conversion.Scope) error {
	...
	if in.Claims != nil {
		...
		*out = make([]genid.GENIDIndexClaim, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_GENIDIndexClaim_To_genid_GENIDIndexClaim(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_genid_GENIDIndexSpec_To_v1alpha1_GENIDIndexSpec(in *genid.GENIDIndexSpec, out *GENIDIndexSpec, s conversion.Scope) error {
	...
	if in.Claims != nil {
		in, out := &in.Claims, &out.Claims
		*out = make([]GENIDIndexClaim, len(*in))
		for i := range *in {
			if err := Convert_genid_GENIDIndexClaim_To_v1alpha1_GENIDIndexClaim(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
