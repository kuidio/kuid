...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyntaxValidator) DeepCopyInto(out *SyntaxValidator) {
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyntaxValidator.
func (in *SyntaxValidator) DeepCopy() *SyntaxValidator {
	if in == nil {
		return nil
	}
	out := new(SyntaxValidator)
	in.DeepCopyInto(out)
	return out
}
