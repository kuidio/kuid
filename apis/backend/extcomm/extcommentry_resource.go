...
var _ resource.InternalObject = &EXTCOMMEntry{}
var _ resource.ObjectList = &EXTCOMMEntryList{}
var _ resource.ObjectWithStatusSubResource = &EXTCOMMEntry{}
var _ resource.StatusSubResource = &EXTCOMMEntryStatus{}

func (EXTCOMMEntry) GetGroupVersionResource() schema.GroupVersionResource {
	return schema.GroupVersionResource{
		Group:    SchemeGroupVersion.Group,
		Version:  SchemeGroupVersion.Version,
		Resource: EXTCOMMEntryPlural,
	}
}
...
func (r *EXTCOMMEntry) IsEqual(ctx context.Context, obj, old runtime.Object) bool {
	newobj := obj.(*EXTCOMMEntry)
	oldobj := old.(*EXTCOMMEntry)
...
func (EXTCOMMEntryStatus) SubResourceName() string {
	return fmt.Sprintf("%s/%s", EXTCOMMEntryPlural, "status")
}

// CopyTo copies the content of the status subresource to a parent resource.
// CopyTo implements the resource.StatusSubResource
func (r EXTCOMMEntryStatus) CopyTo(obj resource.ObjectWithStatusSubResource) {
	parent, ok := obj.(*EXTCOMMEntry)
	if ok {
		parent.Status = r
	}
}
...
func (r *EXTCOMMEntry) FieldSelector() func(ctx context.Context, fieldSelector fields.Selector) (resource.Filter, error) {
	return func(ctx context.Context, fieldSelector fields.Selector) (resource.Filter, error) {
		var filter *EXTCOMMEntryFilter

		// add the namespace to the list
		namespace, ok := genericapirequest.NamespaceFrom(ctx)
		if fieldSelector == nil {
			if ok {
				return &EXTCOMMEntryFilter{Namespace: namespace}, nil
			}
			return filter, nil
		}
		requirements := fieldSelector.Requirements()
		for _, requirement := range requirements {
			filter = &EXTCOMMEntryFilter{}
		...
		if ok {
			if filter != nil {
				...
				filter = &EXTCOMMEntryFilter{Namespace: namespace}
			}
			return filter, nil
		}

		return &EXTCOMMEntryFilter{}, nil
	}
...
func (r *EXTCOMMEntry) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	newobj := obj.(*EXTCOMMEntry)
	newobj.Status = EXTCOMMEntryStatus{}
}
